...
function openAPIOperation(service, operation) {
  ...
  return {
    ...
    responses: {
      ...
      "429": { description: "Rate or cost limit exceeded" },
    },
...
function generateOpenAPI(plane) {
  ...
  return {
    ...
    components: { securitySchemes: securitySchemes(), schemas: collectSchemas() },
...
const outputs = [
  ...
  writeText("service-sdk/go/service_contract_sdk.go", goSDK()),
  writeText("service-sdk/typescript/serviceContractSDK.ts", typeScriptSDK()),
];
