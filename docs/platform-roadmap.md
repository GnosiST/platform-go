...
`github-release-publication` is `pending` and remains the sole v0.1.0 release blocker. The repository, CI and Pages are ready, but no Git tag or formal GitHub Release may be created until the user explicitly authorizes publication.
